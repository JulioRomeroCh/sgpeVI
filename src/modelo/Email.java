...
public class Email {//Inicio de la clase Email
  ...
  */
  public void enviarCorreo () throws AddressException, MessagingException {
    ...
    adjunto.setDataHandler (new DataHandler (new FileDataSource("C:\\Users\\KevRj\\OneDrive\\Documents\\NetBeansProjects"
        + "\\sgpeVI\\planEstudios.pdf")));
